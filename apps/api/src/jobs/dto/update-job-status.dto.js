...
__decorate([
    (0, swagger_1.ApiProperty)({ enum: job_status_enum_1.JobStatus, example: job_status_enum_1.JobStatus.RUNNING }),
...
__decorate([
    (0, swagger_1.ApiProperty)({
        ...
        example: job_status_enum_1.JobStatus.PENDING,
        description: 'Status last seen by the client; used to reject stale updates',
    }),
    (0, class_validator_1.IsEnum)(job_status_enum_1.JobStatus),
    __metadata("design:type", String)
], UpdateJobStatusDto.prototype, "expectedStatus", void 0);
